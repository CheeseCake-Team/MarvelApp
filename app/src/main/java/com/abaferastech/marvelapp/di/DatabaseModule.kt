...
object DatabaseModule {
    ...
    @Singleton
    @Provides
    fun provideFavouriteDao(marvelDatabase: MarvelDatabase): FavouriteDao {
        return marvelDatabase.favouriteDao()
    }

    @Singleton
    @Provides
    fun provideSearchDaoDao(marvelDatabase: MarvelDatabase): SearchDao {
